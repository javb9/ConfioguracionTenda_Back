...
class TendaManager(object):
    ...
    __SET_WIFI_SETTINGS_URL = 'http://{}/goform/setWifi'
    __COOKIE = ''
    ...
    def __init__(self, IP, PASSWORD):
        ...
        self.__WIFI_SETTINGS_URL = self.__WIFI_SETTINGS_URL.format(IP)
        self.__SET_WIFI_SETTINGS_URL = self.__SET_WIFI_SETTINGS_URL.format(IP)
    ...
    def do_login(self):
        ...
        print ("self", (self.__AUTH_URL), (form_data), (self.__WIFI_SETTINGS_URL))
        try:
